...
public class CommonUtil {
    ...
    public static String getUserIdentifier(Context context) {
        ...
        SharedPreferences localSharedPreferences = context.getSharedPreferences("ums_agent_online_setting_"
                + packageName, 0);
    ...
    public static String getAppKey(Context paramContext) {
        ...
        try {
            ...
            if (localApplicationInfo != null) {
                String umengkey = localApplicationInfo.metaData.getString("UMENG_APPKEY");
                String channel = localApplicationInfo.metaData.getString("UMENG_CHANNEL");
                if (!TextUtils.isEmpty(umengkey) && !TextUtils.isEmpty(channel)) {
                    return umengkey + "_" + channel;
                }
                if (UmsConstants.DebugMode)
                    Log.e("UmsAgent", "Could not read UMENG_APPKEY & UMENG_CHANNEL meta-data from AndroidManifest.xml.");
            }
