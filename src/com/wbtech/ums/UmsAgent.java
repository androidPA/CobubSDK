...
public class UmsAgent {
    ...
    public static void init(Context context, boolean debug){
         ...
         * 
         * The UmsAgent.update(Context context) method can check whether there is a new version App automatically, and notify user whether to ungrade SDK if
         * there is a new App SDK. SDK will upgrade after user choose to ungrade. (whether to ungrade according to version code)
         * 
         * Call UmsAgent.update(this) in onCreate() method of Activity. In consideration of limitation of the user's traffic, we set that the function of auto
         * prompting is started only under Wi-Fi
         * 
         * UmsAgent.update(this);//使用自己的更新应用，不用Ums的
         * */
        
        /**
         * SDK could help you catch exit exception during App usage and send error report to server.
         * 
         * Error report includes App version, OS version, device type and stacktrace of exception.
         * 
         * These data will help you modify App bug.
         * 
         * We provide two ways to report error info.
         * 
         * One is catched automatically by system and another is passed by developers.
         * 
         * For the former, you need to add android.permission.READ_LOGS permission in AndroidManifest.xml and call UmsAgent.onError(Context) in onCreate of Main
         * Activity
         * 
         * 
         * For the latter, developers need to call UmsAgent.onError(Context,String) and pass error info catched by their own to the second parameter. You can
         * view error report in product page of Cobub Razor system.
         * */

        /**
         * Data sending We have two modes: 1.Start sending(recommended) 2.Real-time Sending
         * 
         * Start sending(recommended): App only sends a message to server when it starts and all messages produced during the App runtime will be sent to server
         * on next time start. If the App starts without network, then the messages will be stored in local position and App will try to send next time.
         * 
         * Real-time Sending : Once App produces a message, sending it to server immediately.
         * 
         * Call UmsAgent.setDefaultReportPolicy(Context,int) to select mode of sending data param: int 0:Start sending 1:Real-time Sending
         * 
         * */
        UmsAgent.setDefaultReportPolicy(context, 1);//
        
        /**
         * Call UmsAgent.postClientData(this) in onCreate method of every Activity. Parameter is context of current context. Then, client data could be posted
         * to Cobub Razor system.
         * 
         * */
